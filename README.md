...
Hey! Here's a helpful little bug tracker for known issues with [DayCount](https://daycountapp.com), so if you have a bug to report you can check the “Issues” tab up above to see if it's already been reported. I can't promise I'll be able to fix the bug in a report instantly, but I do really want to know about the bugs so I can fix them as soon as I can! 
